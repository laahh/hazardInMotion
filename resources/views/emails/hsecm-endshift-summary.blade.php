...
<head>
  ...
  <title>Akhir Shift — Summary</title>
  <style type="text/css">
    ...
    .detail-table th { background: #ecfdf5; color: #065f46; font-size: 10px; text-transform: uppercase; letter-spacing: 0.04em; font-weight: 700; padding: 8px 10px; text-align: left; border-bottom: 1px solid #a7f3d0; white-space: nowrap; }
...
@php
  ...
  $scopeHint = ($scope['site'] ?? '') !== '' && ($scope['perusahaan'] ?? '') === ''
      ? 'seluruh perusahaan di site '.$siteLabel
      : (($scope['site'] ?? '') === '' && ($scope['perusahaan'] ?? '') === ''
          ? 'semua site'
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f4;">
  <tr>
    <td align="center" style="padding:24px 12px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:760px;background:#ffffff;border:1px solid #a7f3d0;border-radius:16px;overflow:hidden;">
        <tr>
          <td style="background:linear-gradient(135deg,#0f766e 0%,#115e59 100%);padding:22px 28px;">
            <div style="font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:rgba(255,255,255,.85);font-weight:700;">Akhir Shift — Summary</div>
        ...
        <tr>
          <td style="padding:28px;">
            ...
            <p style="margin:0 0 18px;font-size:13px;line-height:1.65;color:#475569;">
              {{ $role }} · Shift telah <strong>berakhir</strong>. Berikut ringkasan monitoring untuk
              <strong>{{ $scopeHint }}</strong>. Email Tasklist (upload evidence) hanya dikirim ke PIC yang punya
              site &amp; perusahaan spesifik.
            </p>
            ...
            <p style="margin:22px 0 12px;font-size:13px;line-height:1.6;color:#334155;">
              Berikut gap yang menjadi concern dan perlu ditindaklanjuti setelah akhir shift:
            </p>
            ...
            <p style="margin:0;font-size:13px;line-height:1.65;color:#334155;">
              Mohon gap di atas dikontrol. Upload evidence dilakukan oleh PIC per site + perusahaan melalui Tasklist.
            </p>
        ...
        <tr>
          <td style="background:#0f172a;color:#94a3b8;padding:16px 28px;font-size:11px;line-height:1.6;">
            <strong style="color:#e2e8f0;">Akhir Shift — Summary</strong><br/>
            Dikirim otomatis dari sistem monitoring HSE untuk oversight (bukan pintu upload Tasklist).
          </td>
        </tr>
      </table>
    </td>
