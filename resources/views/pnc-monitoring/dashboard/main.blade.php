                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center gap-12">
                                <div class="w-40-px h-40-px radius-8 flex-shrink-0 bg-info-50 d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('wowdash-admin/assets/images/home-six/category-icon1.png') }}" alt="" class="">
                                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center gap-12">
                                <div class="w-40-px h-40-px radius-8 flex-shrink-0 bg-success-50 d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('wowdash-admin/assets/images/home-six/category-icon2.png') }}" alt="" class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center gap-12">
                                <div class="w-40-px h-40-px radius-8 flex-shrink-0 bg-lilac-50 d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('wowdash-admin/assets/images/home-six/category-icon3.png') }}" alt="" class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center gap-12">
                                <div class="w-40-px h-40-px radius-8 flex-shrink-0 bg-warning-50 d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('wowdash-admin/assets/images/home-six/category-icon4.png') }}" alt="" class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center gap-12">
                                <div class="w-40-px h-40-px radius-8 flex-shrink-0 bg-danger-50 d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('wowdash-admin/assets/images/home-six/category-icon5.png') }}" alt="" class="">
                                </div>
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-0">
                            <div class="d-flex align-items-center gap-12">
                                <div class="w-40-px h-40-px radius-8 flex-shrink-0 bg-primary-50 d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('wowdash-admin/assets/images/home-six/category-icon6.png') }}" alt="" class="">
                                </div>
                                <div class="flex-grow-1">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/users/user1.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/users/user2.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/users/user3.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/users/user4.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/users/user5.png') }}" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
            ...
            <div class="col-xxl-4 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/home-six/student-img1.png') }}" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/home-six/student-img2.png') }}" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/home-six/student-img3.png') }}" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/home-six/student-img4.png') }}" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/home-six/student-img5.png') }}" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-0">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('wowdash-admin/assets/images/home-six/student-img6.png') }}" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
