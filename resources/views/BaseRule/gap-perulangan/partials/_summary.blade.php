{{-- Ringkasan matriks program × Site / Perusahaan (header 2 tingkat) --}}
@php
...
<div class="hsecm-card rounded-2xl overflow-hidden mb-8">
   <div class="px-5 py-4 border-b border-slate-100 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      <div>
         ...
         <p class="text-xs text-on-surface-variant mt-0.5">Jumlah gap berulang per program · kolom Site → Perusahaan</p>
      </div>
         ...
         <tbody>
            ...
            <tr>
               <td colspan="{{ max(2, $columnCount + 1) }}" class="px-4 py-8 text-center text-on-surface-variant">
                  Tidak ada data gap perulangan untuk filter yang dipilih.
               </td>
            </tr>
            @endforelse
         </tbody>
