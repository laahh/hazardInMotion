...
@section('title', 'Reporting & Analytics - Safety Reports - Beraucoal')
...
<div class="reporting-header">
    <h1 class="reporting-title">Reporting & Analytics - Safety Reports</h1>
    <p class="reporting-subtitle">View and manage safety reports</p>
</div>

<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Safety Reports</h5>
        ...
        <div class="report-card">
            ...
            <div class="metrics-grid">
                ...
                <div class="metric-item">
                    ...
                    <div class="metric-label">{{ str_replace('_', ' ', ucwords($label)) }}</div>
                </div>
                @endforeach
            </div>
