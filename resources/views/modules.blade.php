...
@section('title', ($dept['name'] ?? null) ? $dept['name'] . ' - Module' : 'Module')
...
<div class="mega-menu-widgets container-fluid bg-white">
  <div class="row mb-3 mt-3">
    <div class="col-12 d-flex align-items-center gap-3">
      <a href="{{ route('index') }}" class="btn btn-light rounded-circle d-flex align-items-center justify-content-center module-back-btn" title="Kembali ke Beranda">
        <span class="material-icons-outlined">arrow_back</span>
      </a>
      <div>
        <h4 class="mb-0">{{ $dept['name'] ?? 'Semua Module' }}</h4>
        @if (!empty($dept['subtitle']))
          <p class="mb-0 text-secondary f-14">{{ $dept['subtitle'] }}</p>
        @endif
      </div>
    </div>
  </div>
