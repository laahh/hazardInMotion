  ...
  <div class="offcanvas-body">
    ...
    <div id="soDrawerContent" class="d-none">
      ...
      <div class="mb-24">
        ...
        <div id="soDrawerFatigueDetail"></div>
      </div>
...
(function(){
  ...
  var tierBadgeCls = { hijau: 'bg-success-focus text-success-main', kuning: 'bg-warning-focus text-warning-main', merah: 'bg-danger-focus text-danger-main' };

  // Dipakai kedua drawer (Saat Operasi & Pra Operasi) — riwayat detail Fit to
  // Work 7 hari terakhir (sobriety test, kondisi, jam tidur, tindakan unfit),
  // bukan cuma hari ini, supaya polanya kelihatan seminggu ke belakang.
  function renderFatigueCheckHistory(containerId, list) {
    ...
    el.innerHTML = '<div class="accordion" id="' + accordionId + '">' + list.map(function(day, idx){
      ...
      var tier = day.tier ? tierLabel[day.tier] : 'Belum Tes';
      var badgeCls = day.tier ? (tierBadgeCls[day.tier] || 'bg-neutral-200 text-neutral-600') : 'bg-neutral-200 text-neutral-600';
      var detailRows = [
      ...
      return '<div class="accordion-item">' +
        '<h2 class="accordion-header"><button class="accordion-button ' + (idx === 0 ? '' : 'collapsed') + ' text-sm py-8 px-12" type="button" data-bs-toggle="collapse" data-bs-target="#' + itemId + '">' +
          ...
          '<span class="' + badgeCls + ' px-8 py-2 rounded-pill text-xs fw-medium ms-8">' + escapeHtml(tier) + '</span>' +
        '</button></h2>' +
  ...
  function renderProfile(profile) {
    ...
    renderFatigueCheckHistory('soDrawerFatigueDetail', profile.fatigueCheckHistory || []);
