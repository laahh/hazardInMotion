...
@section('content')
    <x-page-title title="Tambah Insiden" pagetitle="Insiden Tabel" />

    <div class="card rounded-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Form Tambah Insiden</h5>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('insiden-tabel.store') }}" class="mt-3">
                @csrf
