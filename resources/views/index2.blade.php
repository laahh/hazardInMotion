...
@section('content')
    ...
    <x-page-title title="Dashboard" pagetitle="Alternate" />
      ...
      <tableau-viz id='tableau-viz' src='https://idashboard.beraucoal.co.id/t/hsedivision/views/OverviewSafetyPerformance_17471016698280/OverviewSafetyPerformanceAllSites2' width='1654' height='1209' hide-tabs toolbar='bottom' ></tableau-viz>
