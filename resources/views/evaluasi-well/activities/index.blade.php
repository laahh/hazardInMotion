...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Detail Aktivitas</h6>
    <ul class="d-flex align-items-center gap-2">
        ...
        <li>-</li>
        <li class="fw-medium">Detail Aktivitas</li>
    </ul>
</div>

<div class="card h-100 p-0 radius-12">
    <div class="card-header border-bottom bg-base py-16 px-24">
        <h6 class="text-lg fw-semibold mb-0">Aktivitas Olahraga</h6>
    </div>
    <div class="card-body p-24">
        <div class="alert alert-info bg-info-100 text-info-600 border-info-100 px-24 py-13 mb-0 radius-8 d-flex align-items-start gap-2" role="alert">
            ...
            <div>
                Halaman ini memakai layout template <strong>index-2.html</strong>.
                Integrasi database / DataTables akan ditambahkan belakangan.
            </div>
        </div>
    </div>
</div>
