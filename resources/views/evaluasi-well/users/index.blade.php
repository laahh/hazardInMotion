  ...
  <div class="card-header border-bottom bg-base py-16 px-24">
    <div class="d-flex align-items-start justify-content-between flex-wrap gap-3">
      ...
      <div class="d-flex flex-wrap gap-2">
        <form action="{{ route('evaluasi-well.users.sync-hse') }}" method="POST" class="d-inline" onsubmit="return confirm('Jalankan sync HSE? Karyawan baru akan ditambahkan; data existing (perusahaan, status, jabatan, dll.) akan di-update tanpa mengubah ID. SID yang hilang dari roster HSE otomatis NONAKTIF. Password existing tidak direset.');">
          @csrf
