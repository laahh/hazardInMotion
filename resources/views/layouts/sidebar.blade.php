<aside class="sidebar-wrapper">
    ...
    <div class="sidebar-nav" data-simplebar="true">
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li class="menu-label">Validasi Data Laporan</li>
           <li>
            <a href="{{ route('hse-validation.index') }}">
               <div class="parent-icon"><i class="material-icons-outlined">fitbit</i>
              </div>
              <div class="menu-title">Validasi Laporan</div>
            </a>
          </li>
          <li>
            <a href="{{ route('report-weekly.index') }}">
              <div class="parent-icon"><i class="material-icons-outlined">toc</i>
              </div>
              <div class="menu-title">Report Weekly</div>
            </a>
