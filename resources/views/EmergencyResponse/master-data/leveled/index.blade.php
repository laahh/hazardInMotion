                    ...
                    <tbody>
                        @forelse ($items as $item)
                            <tr>
                                ...
                                <td>{{ $item->code }}</td>
                                <td>{{ $item->name }}</td>
                                <td><span class="badge px-16 py-4 radius-4" style="background-color: {{ $item->color }}; color: #fff;">{{ $item->name }}</span></td>
                                <td>
                                    @if ($item->is_active)
                                ...
                                <td class="text-end">
                                    <button type="button" class="btn btn-sm btn-outline-primary-600" data-bs-toggle="modal" data-bs-target="#editModal-{{ $item->id }}"><i class="ri-edit-line"></i></button>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 mb-3">
                                                        ...
                                                        <input type="number" name="level" class="form-control" value="{{ old('level', $item->level) }}" required min="1" max="20">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="color" name="color" class="form-control form-control-color" value="{{ old('color', $item->color) }}">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="form-check form-switch">
                                                    ...
                                                    <input type="checkbox" name="is_active" value="1" class="form-check-input" id="lvl-active-{{ $item->id }}" @checked($item->is_active)>
                                                    <label class="form-check-label" for="lvl-active-{{ $item->id }}">Aktif</label>
                                                </div>
                                            </div>
                        ...
                        @empty
                            <tr><td colspan="6" class="text-center text-secondary-light py-24">Belum ada data.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
                ...
                <form action="{{ route("{$routeName}.store") }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <label class="form-label">Level (urutan)</label>
                                <input type="number" name="level" class="form-control" value="{{ old('level') }}" required min="1" max="20">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama</label>
                        ...
                        <div class="form-check form-switch">
                            <input type="hidden" name="is_active" value="0">
                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="lvl-active-new" checked>
                            <label class="form-check-label" for="lvl-active-new">Aktif</label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
