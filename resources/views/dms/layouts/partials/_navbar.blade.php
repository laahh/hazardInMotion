    ...
    <div class="col-auto">
      <div class="d-flex flex-wrap align-items-center gap-3">
        <button type="button" data-theme-toggle class="w-40-px h-40-px bg-neutral-200 rounded-circle d-flex justify-content-center align-items-center">
          <iconify-icon icon="solar:sun-2-outline" class="icon text-xl"></iconify-icon>
        </button>
            ...
            <ul class="to-top-list">
              <li>
                <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href="{{ url('/') }}">
                  <iconify-icon icon="solar:widget-5-outline" class="icon text-xl"></iconify-icon> Panel Utama
                </a>
              </li>
              <li>
