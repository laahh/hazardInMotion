...
Route::middleware('auth')->group(function (): void {
    ...
    Route::post('/leave/list', [LeaveController::class, 'list'])->name('leave.list');
    Route::get('/leave/history', [LeaveController::class, 'history'])->name('leave.history');
    Route::get('/leave/show', [LeaveController::class, 'show'])->name('leave.show');
    ...
    Route::get('/tracker/show', [TrackerController::class, 'show'])->name('tracker.show');
    ...
    Route::post('/tracker/delete', [TrackerController::class, 'delete'])->name('tracker.delete');
