...
Route::middleware(['auth', 'evaluasi-well.mitra-only'])->group(function () {
    ...
    Route::get('/peer-pressure-edukasi/dashboard/pelaksanaan-baseline-detail', [PeerPressureEdukasiController::class, 'pelaksanaanBaselineDetailData'])->name('peer-pressure-edukasi.dashboard.pelaksanaan-baseline-detail');
    ...
    Route::prefix('pra-operasi')->name('pra-operasi.')->group(function () {
        ...
        Route::get('/dashboard/widgets/quadrant', [\App\Http\Controllers\PraOperasi\DmsAlertMonitoringController::class, 'widgetQuadrant'])->name('dms-monitoring.widget.quadrant');
        Route::get('/dashboard/widgets/control-room', [\App\Http\Controllers\PraOperasi\DmsAlertMonitoringController::class, 'widgetControlRoom'])->name('dms-monitoring.widget.control-room');
        ...
        Route::get('/dashboard/kpi-overall/people-day', [\App\Http\Controllers\PraOperasi\DmsAlertMonitoringController::class, 'overallPeopleModalDay'])
            ->name('dms-monitoring.kpi-overall.people-day');
        Route::get('/dashboard/kpi-overall/unit-alerts', [\App\Http\Controllers\PraOperasi\DmsAlertMonitoringController::class, 'overallModalUnitAlerts'])
            ->name('dms-monitoring.kpi-overall.unit-alerts');
        Route::get('/dashboard/kpi-overall/people-alerts', [\App\Http\Controllers\PraOperasi\DmsAlertMonitoringController::class, 'overallPeopleModalAlerts'])
            ->name('dms-monitoring.kpi-overall.people-alerts');
