...
class MonitoringSafetyEngineeringOutsideCommitmentService
{
    ...
    public function buildDashboard(Request $request): array
    {
        ...
        $arahanManajemenItems = $itemsByCategory['arahan_manajemen'];
        $rekomInsidenItems = $itemsByCategory['rekom_insiden'];
        $rekomGrItems = $itemsByCategory['rekom_gr'];
        ...
        return [
            ...
            'summary' => $this->buildSummary($records, $arahanManajemenItems, $rekomInsidenItems, $rekomGrItems),
            'overdue_summary' => $this->buildOverdueSummary($arahanManajemenItems, $rekomInsidenItems, $rekomGrItems),
            'active_category' => $activeCategory,
            'active_items' => $activeItems,
            'arahan_manajemen_items' => $arahanManajemenItems,
            'rekom_insiden_items' => $rekomInsidenItems,
            'rekom_gr_items' => $rekomGrItems,
            'brief_analysis' => $this->buildBriefAnalysis($records, $arahanManajemenItems, $rekomInsidenItems, $rekomGrItems),
            'next_todo' => $this->buildNextTodo($records),
            'charts' => $this->buildCharts($arahanManajemenItems, $rekomInsidenItems, $rekomGrItems, $records),
    ...
    private function emptyDashboard(array $filters): array
    {
        ...
        return [
            ...
            'arahan_manajemen_items' => $emptyItems,
            'rekom_insiden_items' => $emptyItems,
            'rekom_gr_items' => $emptyItems,
            'brief_analysis' => [
                [
    ...
    {
        $meta = config('monitoring_safety_engineering.outside_commitment_categories', []);
        $categories = [
            'arahan_manajemen' => [
                'label' => (string) ($meta['arahan_manajemen']['label'] ?? 'Arahan Manajemen'),
                'color' => (string) ($meta['arahan_manajemen']['color'] ?? '#1e3a5f'),
                'items' => $replikasi,
            ],
            'rekom_insiden' => [
                'label' => (string) ($meta['rekom_insiden']['label'] ?? 'Rekom. Insiden'),
                'color' => (string) ($meta['rekom_insiden']['color'] ?? '#0891b2'),
                'items' => $safety,
            ],
            'rekom_gr' => [
                'label' => (string) ($meta['rekom_gr']['label'] ?? 'Rekom Pelanggaran GR'),
                'color' => (string) ($meta['rekom_gr']['color'] ?? '#b45309'),
                'items' => $additional,
            ],
        ];
    ...
    {
        $grouped = [
            'arahan_manajemen' => collect(),
            'rekom_insiden' => collect(),
            'rekom_gr' => collect(),
        ];
        ...
        $configMeta = config('monitoring_safety_engineering.outside_commitment_categories', []);
        $meta = [
            'arahan_manajemen' => [
                'label' => (string) ($configMeta['arahan_manajemen']['label'] ?? 'Arahan Manajemen'),
                'color' => (string) ($configMeta['arahan_manajemen']['color'] ?? '#1e3a5f'),
            ],
            'rekom_insiden' => [
                'label' => (string) ($configMeta['rekom_insiden']['label'] ?? 'Rekom. Insiden'),
                'color' => (string) ($configMeta['rekom_insiden']['color'] ?? '#0891b2'),
            ],
            'rekom_gr' => [
                'label' => (string) ($configMeta['rekom_gr']['label'] ?? 'Rekom Pelanggaran GR'),
                'color' => (string) ($configMeta['rekom_gr']['color'] ?? '#b45309'),
            ],
        ];
    ...
    {
        return $this->outsideCommitmentSumberValues();
    }
    ...
    {
        return [
            ['label' => 'Arahan Manajemen', 'overdue' => $this->sumOverdue($replikasi)],
            ['label' => 'Rekom. Insiden', 'overdue' => $this->sumOverdue($safety)],
            ['label' => 'Rekom Pelanggaran GR', 'overdue' => $this->sumOverdue($additional)],
        ];
    }
