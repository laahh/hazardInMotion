...
final class MonitoringSafetyEngineeringExcelImportService
{
    ...
    private function parseRow(array $row, int $rowNumber, int $periodYear): array
    {
        ...
        return [
            ...
            'total_risiko_signifikan' => $this->parseNullableInteger($row[Excel::COL_TOTAL_RISIKO_SIGNIFIKAN] ?? null),
            'link_list_risiko_signifikan' => $this->nullableString($row[Excel::COL_LINK_LIST_RISIKO_SIGNIFIKAN] ?? null),
            'jumlah_risiko_signifikan_tercover_rekayasa' => $this->parseNullableInteger($row[Excel::COL_JUMLAH_RISIKO_SIGNIFIKAN_TERCOVER] ?? null),
            'link_risiko_signifikan_tercover_rekayasa' => $this->nullableString($row[Excel::COL_LINK_RISIKO_SIGNIFIKAN_TERCOVER] ?? null),
