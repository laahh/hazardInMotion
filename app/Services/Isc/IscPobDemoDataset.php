...
final class IscPobDemoDataset
{
    ...
    public function events(): array
    {
        return [
            [
                ...
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_DANGER,
                'besigma_violation_id' => 'demo-v-budi',
            ...
            [
                ...
                'hazard_name' => 'Zona Peledakan Pit BMO',
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_COMPETENCE,
                'besigma_violation_id' => 'demo-v-farah',
            ...
            [
                ...
                'hazard_name' => 'Zona Peledakan Pit BMO',
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_DANGER,
                'besigma_violation_id' => 'demo-v-andi',
                'besigma_status' => 'STANDBY',
            ...
            [
                ...
                'iupk_site' => 'Lati',
                'site_code' => 'LMO',
                'hazard_boundary_id' => 'demo-unit-danger',
                'hazard_name' => 'Zona Bahaya Unit LMO',
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_UNIT_DANGER,
                'besigma_violation_id' => 'demo-v-unit-1',
                'besigma_status' => 'DANGER',
                'entered_at' => now()->subMinutes(18)->toIso8601String(),
                'exited_at' => null,
                'duration_seconds' => 18 * 60,
                'status' => 'open',
                'rule_code' => 'hazard-entry',
            ...
            [
                'id' => 9005,
                'person_key' => 'sid:2E2AF',
                'entity' => 'person',
                'sid' => '2E2AF',
                'name' => 'Ifa Aprillianto',
                'company' => 'PT Berau Coal Energy',
                'job_title' => 'Safety Evaluator',
                'lat' => 1.975,
                'lng' => 117.410,
                'iupk_site' => 'Sambarata',
                'site_code' => 'SMO',
                'hazard_boundary_id' => 'demo-smo-hazard',
                'hazard_name' => 'Zona Bahaya SMO',
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_DANGER,
                'besigma_violation_id' => 'demo-v-ifa',
                'besigma_status' => 'DANGER',
                'entered_at' => now()->subMinutes(25)->toIso8601String(),
                'exited_at' => null,
            ...
            [
                ...
                'iupk_site' => 'Gurimbang',
                'site_code' => 'GMO',
                'hazard_boundary_id' => 'demo-gmo-comp',
                'hazard_name' => 'Zona Kompetensi GMO',
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_COMPETENCE,
                'besigma_violation_id' => 'demo-v-vr9t7',
                'besigma_status' => 'WARNING',
                'entered_at' => now()->subMinutes(55)->toIso8601String(),
                'exited_at' => null,
            ...
            [
                'id' => 9007,
                'person_key' => 'sid:KIYX2',
                'entity' => 'person',
                'sid' => 'KIYX2',
                'name' => 'Demo Personel Punan',
                'company' => 'Mitra Kerja',
                'job_title' => 'Operator',
                'lat' => 2.080,
                'lng' => 117.480,
                'iupk_site' => 'Punan',
                'site_code' => 'PUNAN',
                'hazard_boundary_id' => 'demo-punan-hazard',
                'hazard_name' => 'Zona Bahaya Punan',
                'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_DANGER,
                'besigma_violation_id' => 'demo-v-kiyx2',
                'besigma_status' => 'STANDBY',
                'entered_at' => now()->subMinutes(12)->toIso8601String(),
                'exited_at' => null,
    ...
    /**
     * Pelanggaran aktif dummy untuk command --demo / tasklist peta.
     *
     * @return array{people:list<array<string, mixed>>,units:list<array<string, mixed>>}
     */
    public function activeViolations(): array
    {
        return [
            'people' => [
                [
                    ...
                    'company' => 'PT Pamapersada',
                    'job_title' => 'Pengawas Pit',
                    'site' => 'Site Binungan 2',
                    'site_code' => 'BMO',
                    'boundary_id' => 'demo-pit-blast',
                    'hazard_name' => 'Zona Peledakan Pit BMO',
                    'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_DANGER,
                    'status' => 'DANGER',
                    'entered_at' => now()->subMinutes(42)->toDateTimeString(),
                    'lat' => 1.990,
                    'lng' => 117.385,
                ],
                [
                    ...
                    'hazard_kind' => IscHazardBoundaryClassifier::KIND_EMPLOYEE_COMPETENCE,
                    'status' => 'WARNING',
                    'entered_at' => now()->subHours(2)->toDateTimeString(),
                    'lat' => 1.988,
                    'lng' => 117.390,
                ],
            ],
            'units' => [
                [
                    ...
                    'site' => 'Lati',
                    'site_code' => 'LMO',
                    'boundary_id' => 'demo-unit-danger',
                    'hazard_name' => 'Zona Bahaya Unit LMO',
                    'hazard_kind' => IscHazardBoundaryClassifier::KIND_UNIT_DANGER,
                    'status' => 'DANGER',
                    'entered_at' => now()->subMinutes(18)->toDateTimeString(),
                ],
            ],
        ];
    }
