    ...
    private function analysisCards(): array
    {
        return [
            [
                ...
                'total' => 1482,
                'pct' => 7.6,
                'colors' => ['#DC2626', '#F86624', '#94A3B8'],
                'legend' => [
                    ['label' => 'Melebihi target kalori', 'pct' => 38.2, 'count' => 566, 'color' => '#DC2626', 'icon' => 'mdi:arrow-up-bold'],
                    ['label' => '<50% target kalori', 'pct' => 22.1, 'count' => 327, 'color' => '#F86624', 'icon' => 'mdi:arrow-down-bold'],
            ...
            [
                ...
                'total' => 1126,
                'pct' => 5.8,
                'colors' => ['#DC2626', '#F86624', '#F86624', '#94A3B8'],
                'legend' => [
                    ['label' => 'Kalori berlebih', 'pct' => 34.7, 'color' => '#DC2626', 'icon' => 'mdi:fire'],
                    ['label' => 'Lemak tinggi', 'pct' => 41.2, 'color' => '#F86624', 'icon' => 'mdi:oil'],
                    ['label' => 'Karbohidrat tinggi', 'pct' => 28.1, 'color' => '#F4941E', 'icon' => 'mdi:rice'],
            ...
            [
                ...
                'total' => 1904,
                'pct' => 9.8,
                'colors' => ['#DC2626', '#DC2626', '#F86624', '#94A3B8'],
                'legend' => [
                    ['label' => 'Kalori berlebih', 'pct' => 28.9, 'color' => '#DC2626', 'icon' => 'mdi:fire'],
                    ['label' => 'Natrium tinggi', 'pct' => 52.4, 'color' => '#DC2626', 'icon' => 'mdi:shaker-outline'],
                    ['label' => 'Lemak tinggi', 'pct' => 27.1, 'color' => '#F86624', 'icon' => 'mdi:oil'],
            ...
            [
                ...
                'total' => 962,
                'pct' => 5.0,
                'colors' => ['#DC2626', '#F4941E', '#F86624', '#94A3B8'],
                'legend' => [
                    ['label' => 'Kalori berlebih', 'pct' => 26.1, 'color' => '#DC2626', 'icon' => 'mdi:fire'],
                    ['label' => 'Karbohidrat tinggi', 'pct' => 48.6, 'color' => '#F4941E', 'icon' => 'mdi:rice'],
                    ['label' => 'Lemak tinggi', 'pct' => 22.4, 'color' => '#F86624', 'icon' => 'mdi:oil'],
            ...
            [
                ...
                'colors' => ['#DC2626', '#F4941E', '#F86624', '#94A3B8'],
                'legend' => [
                    ['label' => 'Kalori berlebih', 'pct' => 45.3, 'color' => '#DC2626', 'icon' => 'mdi:fire'],
                    ['label' => 'Karbohidrat tinggi', 'pct' => 48.1, 'color' => '#F4941E', 'icon' => 'mdi:rice'],
                    ['label' => 'Lemak tinggi', 'pct' => 36.4, 'color' => '#F86624', 'icon' => 'mdi:oil'],
            ...
            [
                ...
                'total' => 421,
                'pct' => 2.2,
                'colors' => ['#DC2626', '#F86624', '#F4941E', '#94A3B8'],
                'legend' => [
                    ['label' => 'Kalori berlebih', 'pct' => 42.5, 'color' => '#DC2626', 'icon' => 'mdi:fire'],
                    ['label' => 'Lemak tinggi', 'pct' => 39.4, 'color' => '#F86624', 'icon' => 'mdi:oil'],
                    ['label' => 'Kolesterol tinggi', 'pct' => 37.8, 'color' => '#F4941E', 'icon' => 'mdi:water'],
