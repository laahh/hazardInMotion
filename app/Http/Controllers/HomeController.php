    ...
    private function getDivisions(): array
    {
        return [
            [
                ...
                'background' => 'isc-assets/isc-slide2-hero.png',
                'depts' => [
                    ['key' => 'hspa', 'name' => 'HSPA', 'subtitle' => 'Health, Safety, and Physical Asset', 'icon' => 'health_and_safety', 'image' => 'isc-assets/isc-slide2-safety.png', 'imageFit' => 'contain'],
                    ['key' => 'erg', 'name' => 'ERG', 'subtitle' => 'Emergency Response Group', 'icon' => 'emergency', 'image' => 'isc-assets/isc-slide2-goal-safety.png', 'imageFit' => 'contain'],
                    ['key' => 'operation-compliance', 'name' => 'Operation Compliance', 'subtitle' => 'Integrity in Every Operation', 'icon' => 'fact_check', 'image' => 'isc-assets/isc-slide2-footer.png'],
                    ['key' => 'sod', 'name' => 'SOD', 'subtitle' => 'Site Operation Discipline', 'icon' => 'engineering', 'image' => 'isc-assets/isc-slide2-ric.png'],
                    ['key' => 'investigasi', 'name' => 'Investigasi', 'subtitle' => 'Find Facts, Drive Improvement', 'icon' => 'travel_explore', 'image' => 'isc-assets/isc-home-control-room.png'],
                ],
            ],
        ];
    }
