...
final class PncMonitoringIkkRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'finding_ia' => ['nullable', 'integer', 'min:0', 'max:999'],
            'finding_verlap' => ['nullable', 'integer', 'min:0', 'max:999'],
            'ia' => ['nullable', 'integer', 'min:0', 'max:1'],
            'ipk' => ['nullable', 'integer', 'min:0', 'max:1'],
            'plan_okk' => ['nullable', 'integer', 'min:0', 'max:999'],
            'okk_1' => ['nullable', 'integer', 'min:0', 'max:999'],
            'okk_2' => ['nullable', 'integer', 'min:0', 'max:999'],
            'okk_3' => ['nullable', 'integer', 'min:0', 'max:999'],
            'okk_layer_2' => ['nullable', 'integer', 'min:0', 'max:999'],
            'okk_layer_3' => ['nullable', 'integer', 'min:0', 'max:999'],
            'okk_layer_4' => ['nullable', 'integer', 'min:0', 'max:999'],
        ];
    }
